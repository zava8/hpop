...
import org.kibord.hpop5210.Keyboard.Key;
...
import static org.kibord.hpop5210.aski_hksu.aski_dijit_kya;
...
//    private final float KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR = 0.55f; // orijnql
    ...
    static class PointerQueue {
        ...
        public void releaseAllPointersOlderThan(org.kibord.hpop5210.PointerTracker tracker, long eventTime) {
            LinkedList<org.kibord.hpop5210.PointerTracker> queue = mQueue;
            int oldestPos = 0;
            for (org.kibord.hpop5210.PointerTracker t = queue.get(oldestPos); t != tracker; t = queue.get(oldestPos)) {
    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) { super(context, attrs, defStyle);
        fontsoverride.setDefaultFont(context,"DEFAULT",R.font.hin55);
//        fontsoverride.setDefaultFont(context,"DEFAULT_BOLD",R.font.lato5r);
        if (!isInEditMode()) Log.i(TAG, "kreating niyu lAtinkibordbesviyu " + this);
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        mLabelScale = org.kibord.hpop5210.LatinIME.sKeyboardSettings.labelScalePref;
        requestLayout();
        mKeyboardChanged = true;
        invalidateAllKeys();
        computeProximityThreshold(keyboard);
        mMiniKeyboardCacheMain.clear(); mMiniKeyboardCacheShift.clear(); mMiniKeyboardCacheCaps.clear();
        setRenderModeIfPossible(org.kibord.hpop5210.LatinIME.sKeyboardSettings.renderMode);
        mIgnoreMove = true;
    }    
