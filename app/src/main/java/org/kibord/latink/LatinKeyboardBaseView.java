...
import org.kibord.latink.Keyboard.Key;
...
import static org.kibord.latink.aski_hksu.aski_dijit_kya;
...
//    private final float KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR = 0.55f; // orijnql
    ...
    static class PointerQueue {
        ...
        public void releaseAllPointersOlderThan(org.kibord.latink.PointerTracker tracker, long eventTime) {
            LinkedList<org.kibord.latink.PointerTracker> queue = mQueue;
            int oldestPos = 0;
            for (org.kibord.latink.PointerTracker t = queue.get(oldestPos); t != tracker; t = queue.get(oldestPos)) {
...
//        fontsoverride.setDefaultFont(context,"DEFAULT_BOLD",R.font.lato5r);
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        mLabelScale = org.kibord.latink.LatinIME.sKeyboardSettings.labelScalePref;
        requestLayout();
        mKeyboardChanged = true;
        invalidateAllKeys();
        computeProximityThreshold(keyboard);
        mMiniKeyboardCacheMain.clear(); mMiniKeyboardCacheShift.clear(); mMiniKeyboardCacheCaps.clear();
        setRenderModeIfPossible(org.kibord.latink.LatinIME.sKeyboardSettings.renderMode);
        mIgnoreMove = true;
    }    
