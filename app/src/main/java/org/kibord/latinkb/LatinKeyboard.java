...
public class LatinKeyboard extends Keyboard {
    ...
    private static final String TAG = "latinkb";
    ...
    @Override protected Key createKeyFromXml(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
        Key key = new latinkbey(res, parent, x, y, parser);
...
//            mShiftKey.locked = shiftState == SHIFT_LOCKED || shiftState == SHIFT_CAPS_LOCKED;
    ...
    boolean isInside(latinkbey key, int x, int y) {
    ...
    // TODO latinkbey could be static class
    class latinkbey extends Key {
        ...
        public latinkbey(Resources res, Keyboard.Row parent, int x, int y, XmlResourceParser parser) { super(res, parent, x, y, parser); }
