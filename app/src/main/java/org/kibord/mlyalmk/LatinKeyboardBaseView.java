...
import org.kibord.mlyalmk.Keyboard.Key;
...
import static org.kibord.mlyalmk.aski_hksu.aski_dijit_kya;
...
//    private final float KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR = 0.55f; // orijnql
    ...
    static class PointerQueue {
        ...
        public void releaseAllPointersOlderThan(org.kibord.mlyalmk.PointerTracker tracker, long eventTime) {
            LinkedList<org.kibord.mlyalmk.PointerTracker> queue = mQueue;
            int oldestPos = 0;
            for (org.kibord.mlyalmk.PointerTracker t = queue.get(oldestPos); t != tracker; t = queue.get(oldestPos)) {
    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) { super(context, attrs, defStyle);
        fontsoverride.setDefaultFont(context,"DEFAULT",R.font.mlyalm54);
//        fontsoverride.setDefaultFont(context,"DEFAULT_BOLD",R.font.lato5r);
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        mLabelScale = org.kibord.mlyalmk.LatinIME.sKeyboardSettings.labelScalePref;
        requestLayout();
        mKeyboardChanged = true;
        invalidateAllKeys();
        computeProximityThreshold(keyboard);
        mMiniKeyboardCacheMain.clear(); mMiniKeyboardCacheShift.clear(); mMiniKeyboardCacheCaps.clear();
        setRenderModeIfPossible(org.kibord.mlyalmk.LatinIME.sKeyboardSettings.renderMode);
        mIgnoreMove = true;
    }    
...
//                        lebl_size = (int)(mKeyTextSize * 1); // mlyalm
                    ...
                    case "m":
                        lebl_klr = 0xffffffff;
//                        lebl_size = (int)(mKeyTextSize * 1.2f); // telgu mlyalm mlyalmk
                        lebl_size = (int)(mKeyTextSize * 1.8f); //latin
                        lebl_baseline = top_y + labelHeight * KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR * 1.8f;
                    break;
                    case "y":
