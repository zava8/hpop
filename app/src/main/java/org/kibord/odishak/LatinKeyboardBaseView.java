...
import org.kibord.odishak.Keyboard.Key;
...
import static org.kibord.odishak.aski_hksu.aski_dijit_kya;
...
//    private final float KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR = 0.55f; // orijnql
    ...
    static class PointerQueue {
        ...
        public void releaseAllPointersOlderThan(org.kibord.odishak.PointerTracker tracker, long eventTime) {
            LinkedList<org.kibord.odishak.PointerTracker> queue = mQueue;
            int oldestPos = 0;
            for (org.kibord.odishak.PointerTracker t = queue.get(oldestPos); t != tracker; t = queue.get(oldestPos)) {
    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) { super(context, attrs, defStyle);
        fontsoverride.setDefaultFont(context,"DEFAULT",R.font.uria54);
//        fontsoverride.setDefaultFont(context,"DEFAULT_BOLD",R.font.lato5r);
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        mLabelScale = org.kibord.odishak.LatinIME.sKeyboardSettings.labelScalePref;
        requestLayout();
        mKeyboardChanged = true;
        invalidateAllKeys();
        computeProximityThreshold(keyboard);
        mMiniKeyboardCacheMain.clear(); mMiniKeyboardCacheShift.clear(); mMiniKeyboardCacheCaps.clear();
        setRenderModeIfPossible(org.kibord.odishak.LatinIME.sKeyboardSettings.renderMode);
        mIgnoreMove = true;
    }    
