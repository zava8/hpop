...
import org.kibord.tmilk.Keyboard.Key;
...
import static org.kibord.tmilk.aski_hksu.aski_dijit_kya;
...
//    private final float KEY_LABEL_VERTICAL_ADJUSTMENT_FACTOR = 0.55f; // orijnql
    ...
    static class PointerQueue {
        ...
        public void releaseAllPointersOlderThan(org.kibord.tmilk.PointerTracker tracker, long eventTime) {
            LinkedList<org.kibord.tmilk.PointerTracker> queue = mQueue;
            int oldestPos = 0;
            for (org.kibord.tmilk.PointerTracker t = queue.get(oldestPos); t != tracker; t = queue.get(oldestPos)) {
    ...
    public LatinKeyboardBaseView(Context context, AttributeSet attrs, int defStyle) { super(context, attrs, defStyle);
        fontsoverride.setDefaultFont(context,"DEFAULT",R.font.tmil54);
//        fontsoverride.setDefaultFont(context,"DEFAULT_BOLD",R.font.lato5r);
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        mLabelScale = org.kibord.tmilk.LatinIME.sKeyboardSettings.labelScalePref;
        requestLayout();
        mKeyboardChanged = true;
        invalidateAllKeys();
        computeProximityThreshold(keyboard);
        mMiniKeyboardCacheMain.clear(); mMiniKeyboardCacheShift.clear(); mMiniKeyboardCacheCaps.clear();
        setRenderModeIfPossible(org.kibord.tmilk.LatinIME.sKeyboardSettings.renderMode);
        mIgnoreMove = true;
    }    
